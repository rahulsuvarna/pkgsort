...
> **Status:** Draft — describes the *intended* configuration surface. Options are
...
For monorepos, configuration is resolved *per target file* by walking up the
...
> **Note:** pkgsort deliberately does **not** rewrite field *values*. There is
